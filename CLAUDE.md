...
- Demo CTA URL (`https://calendar.app.google/4rC6HTH9hAZHG8XP7`) and contact info (`coflipweb@gmail.com`, `+54 9 11 3337-0937`) are duplicated across `Header`, `Hero`, `CTA`, and `Footer` — update all of them together if these change.
